...
const docs = ref<Doc[]>(demoDocuments)
const sortBy = ref<'name' | 'recent'>('recent')

const sortedDocs = computed(() => {
  if (sortBy.value === 'name') {
    return [...docs.value].sort((a, b) => a.title.localeCompare(b.title))
  }
  return [...docs.value].sort((a, b) => new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime())
})
  ...
  <div class="min-h-screen bg-white dark:bg-slate-900">
    <div class="px-8 py-12">
      <div class="flex items-center justify-between mb-8">
        <h1 class="text-4xl font-bold text-gray-900 dark:text-white">Knowledge Hub</h1><!--Docs-->
