<template>
    <div class="min-h-screen bg-gray-50 dark:bg-slate-900 flex">
        ...
        <div
            class="hidden lg:block w-80 bg-gray-50 dark:bg-slate-900 border-l border-gray-200 dark:border-gray-700 px-6 py-12 h-screen overflow-y-auto sticky top-0 right-0">
            <div class="space-y-6">
                <div>
